...
public class FerrariWeaponsOnline2 : WeaponsOnline
{
    ...
    void Start()
    {
        if (playerEnemy == null)
        {
            playerEnemy = GameObject.FindGameObjectWithTag("PlayerOnline");
        }
        if (player == null)
        {
            player = GameObject.FindGameObjectWithTag("PlayerOnline1");
        }
    }
